...
public class ErrorHandlerController {
    ...
    public ErrorRestResponse handleException(ResponseStatusException e) {
        log.error("Error:{}", e.getMessage(), e);
        List<ErrorResponse> errors = List.of(new ErrorResponse(ErrorCodeConstants.COMMON_ERROR.getCode(), "uri not found."));
        var errorRestResponse = new ErrorRestResponse();
        errorRestResponse.setErrors(errors);
        return errorRestResponse;
    }
    ...
    public ErrorRestResponse handleException(HttpRequestMethodNotSupportedException e) {
        log.error("Error:{}", e.getMessage(), e);
        List<ErrorResponse> errors = List.of(new ErrorResponse(ErrorCodeConstants.COMMON_ERROR.getCode(), "this HTTP Method is not Support."));
        var errorRestResponse = new ErrorRestResponse();
        errorRestResponse.setErrors(errors);
        return errorRestResponse;
    }
